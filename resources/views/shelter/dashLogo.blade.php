  ...
  <div class="flex flex-col content-center justify-center mx-auto mb-4 w-[80%]">
    ...
    <div class="font-body bg-zoning rounded-lg shadow mb-4">
      ...
      <section class="flex flex-col flex-wrap justify-center" id="dashboard-container">
        ...
        <!--        <form class="self-center" method="POST" action="/upload/logo" enctype="multipart/form-data">
        ...
        {{ form_start(form) }}
          ...
          <div class="flex justify-center">
            <div class="flex justify-center my-3 py-2 px-4 mx-auto bg-accents2-dark text-fond transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg">
              {{ form_row(form.save) }}
            </div>
          </div>
        {{ form_end(form) }}
