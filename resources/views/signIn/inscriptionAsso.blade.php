      ...
      <fieldset class="font-body rounded-lg shadow my-2 py-5">
       ...
       <!-- Nom -->
        <div class="mx-auto p-2">
          ...
          <input class="block bg-fond w-full" type="text" id="nom" name="_nom" placeholder="PetSmart" required>
        </div>

        <!-- Président -->
        <div class="mx-auto p-2">
          <label class="text-center w-full" for="responsable">Président</label>
          <input class="block bg-fond w-full" type="text" id="responsable" name="_responsable" placeholder="D. Recteur" required>
        </div>
       ...
       <!-- Adresse -->
        ...
        <div class="mx-auto p-2">
          ...
          <input class="block bg-fond w-full" type="text" id="code_postal" name="_code_postal" pattern="^(?:0[1-9]|[1-8]\d|9[0-8])\d{3}$" placeholder="75020" required>
        </div>
        ...
        <div class="mx-auto p-2">
          ...
          <input class="block bg-fond w-full" type="text" id="siret" name="_siret" pattern="^(\d{14}|((\d{3}[ ]\d{3}[ ]\d{3})|\d{9})[ ]\d{5})$" placeholder="732829320 00074" required>
        </div>
        <div class="mx-auto p-2">
         <!-- Email -->
        ...
        <div class="mx-auto p-2">
          ...
          <input class="block bg-fond w-full" type="url" name="site" id="_site" placeholder="https://example.com" size="40"/>
        </div>

        <!-- Description -->
        <div class="mx-auto p-2">
            <label class="text-center w-full" for="description">Description</label>
            <textarea class="block bg-fond w-full" type="text" rows="5" cols="33" id="description" name="_description"
