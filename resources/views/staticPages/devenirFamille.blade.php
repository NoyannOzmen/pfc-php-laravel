...
<main class="justify-self-stretch flex-1">
  <article class="flex flex-col p-2 lg:p-32 mx-auto">
		<h2 class="font-grands text-center my-6 pb-4 text-3xl"> Devenir famille d'accueil </h2>

		<section class="font-body mx-auto w-[94%] bg-zoning rounded-lg shadow dark:bg-gray-800 my-8">
			<div class="py-4">
    		<h3 class="font-grands my-1 pt-6 text-xl text-center">Qu'est-ce qu'une famille d'accueil ?</h3>
				<div class="flex flex-row gap-4 px-2 items-center">
					<p class="text-texte my-8">
		...
		<section class="font-body mx-auto w-[94%] bg-zoning rounded-lg shadow dark:bg-gray-800 my-8">
			<div class="my-4">
    		<h3 class="font-grands my-1 pt-6 text-xl text-center">Quel est son rôle ?</h3>
				<div class="flex flex-row gap-4 px-2 items-center">
		...
		<section class="font-body mx-auto w-[94%] bg-zoning rounded-lg shadow dark:bg-gray-800 my-8">
			<div class="my-4">
    		<h3 class="font-grands my-1 pt-6 text-xl text-center">Pour quels animaux ?</h3>
				<div class="flex flex-row gap-4 px-2 ">
					<p class="text-texte my-8 text-center">
		...
		<section class="font-body mx-auto w-[94%] bg-zoning rounded-lg shadow dark:bg-gray-800 my-8">
			<div class="my-4">
    			<h3 class="font-grands my-1 pt-6 text-xl text-center">Vous souhaitez devenir famille d'accueil ?</h3>
				<div class="flex flex-row gap-4 px-2">
					<img src="/images/unai.webp" class="size-20 my-8 rounded-lg" alt="Unai, mascotte officielle de Pet Foster Connect">
